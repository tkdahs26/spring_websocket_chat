...
Kafka를 이용해 채팅 메시지를 처리하고, Redis를 이용해 채팅방 참여자 목록 조회를 관리했습니다.
 <br><br>
 <br><br>
...
- `HttpSession`에서 로그인 사용자 정보를 조회하여 채팅방 생성자를 `owner` 으로 지정하고, 생성할때 입력한 방 이름,방 생성자를 `ChatroomRepository`를 통해 MySQL에 저장합니다.
   <br><br>
 <br><br>
 <br><br>
